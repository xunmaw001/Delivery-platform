  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="店铺名称" prop="dianpumingcheng">
              <el-input v-model="ruleForm.dianpumingcheng" 
                placeholder="店铺名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="商家性别" prop="shangjiaxingbie">
        ...
        <div v-else>
          <el-form-item class="input" label="商家性别" prop="shangjiaxingbie">
	      <el-input v-model="ruleForm.shangjiaxingbie"
                placeholder="商家性别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="联系电话" prop="lianxidianhua">
              <el-input v-model="ruleForm.lianxidianhua" 
                placeholder="联系电话" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商家邮箱" prop="shangjiayouxiang">
          <el-input v-model="ruleForm.shangjiayouxiang" 
              placeholder="商家邮箱" clearable  :readonly="ro.shangjiayouxiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商家邮箱" prop="shangjiayouxiang">
              <el-input v-model="ruleForm.shangjiayouxiang" 
                placeholder="商家邮箱" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="店铺地址" prop="dianpudizhi">
              <el-input v-model="ruleForm.dianpudizhi" 
                placeholder="店铺地址" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.shangjiazhaopian" label="商家照片" prop="shangjiazhaopian">
          <file-upload
          tip="点击上传商家照片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.shangjiazhaopian" label="商家照片" prop="shangjiazhaopian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.shangjiazhaopian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                                                                          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dianpumingcheng = true;
            continue;
	            	            ...
	            	            if(o=='shangjiaxingbie'){
            this.ruleForm.shangjiaxingbie = obj[o];
	    this.ro.shangjiaxingbie = true;
            continue;
          }
	            	            if(o=='lianxidianhua'){
