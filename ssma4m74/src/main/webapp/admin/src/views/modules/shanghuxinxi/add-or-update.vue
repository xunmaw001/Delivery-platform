          ...
          <el-form-item class="input" label="月售数量" prop="yueshoushuliang">
              <el-input v-model="ruleForm.yueshoushuliang" 
                placeholder="月售数量" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="开业时间" prop="kaiyeshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.kaiyeshijian" 
                type="datetime"
                placeholder="开业时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.kaiyeshijian" label="开业时间" prop="kaiyeshijian">
              <el-input v-model="ruleForm.kaiyeshijian" 
                placeholder="开业时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="休业时间" prop="xiuyeshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.xiuyeshijian" 
                type="datetime"
                placeholder="休业时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.xiuyeshijian" label="休业时间" prop="xiuyeshijian">
              <el-input v-model="ruleForm.xiuyeshijian" 
                placeholder="休业时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                                                                                      </el-row>
                                                                                                                                                                                                                                                                                                                                                  <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="店铺详情" prop="dianpuxiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.dianpuxiangqing" label="店铺详情" prop="dianpuxiangqing">
                    <span v-html="ruleForm.dianpuxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yueshoushuliang = true;
            continue;
	            	            ...
	            	            if(o=='kaiyeshijian'){
            this.ruleForm.kaiyeshijian = obj[o];
	    this.ro.kaiyeshijian = true;
            continue;
          }
	            	            if(o=='xiuyeshijian'){
            this.ruleForm.xiuyeshijian = obj[o];
	    this.ro.xiuyeshijian = true;
            continue;
          }
	            	            if(o=='thumbsupnum'){
	...
	this.ruleForm.dianpuxiangqing = this.ruleForm.dianpuxiangqing.replace(reg,'../../../ssma4m74/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `shanghuxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shanghuxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
